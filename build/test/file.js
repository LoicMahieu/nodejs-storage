...
const fakeUtil = extend({}, common_1.util, {
    handleResp() {
        (handleRespOverride || common_1.util.handleResp).apply(null, arguments);
    },
    makeWritableStream() {
        const args = arguments;
        (makeWritableStreamOverride || common_1.util.makeWritableStream).apply(null, args);
    },
});
const fakePromisify = {
...
describe('File', () => {
    ...
    describe('initialization', () => {
        ...
        it('should inherit from ServiceObject', () => {
            assert(file instanceof common_1.ServiceObject);
    ...
    describe('getSignedUrl', () => {
        ...
        it('should create a signed url', done => {
            ...
            file.getSignedUrl(CONFIG, (err, signedUrl) => {
                ...
                const expected = 'https://storage.googleapis.com/bucket-name/file-name.png?' +
